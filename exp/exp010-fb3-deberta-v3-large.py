...
def parse_args():
    ...
    parser.add_argument("--output", type=str, default="exp001", required=False)
    parser.add_argument("--model", type=str, required=False, default=0)
    parser.add_argument("--col", type=str, required=False, default=0) 
...
if __name__ == '__main__':
    ...
    args = parse_args()
    CFG.target_cols=[args.col]
    OUTPUT_DIR = args.output + '-' + args.col + "/"
    CFG.model = args.model
    

    print("output path:" + OUTPUT_DIR)
    print("traning model:" + CFG.model)
    print("target col:" + args.col)
